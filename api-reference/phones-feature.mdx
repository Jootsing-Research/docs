...
| Screenshot | `GET /phones/{id}/screenshot` | Capture the current screen |
...
| `GET /phones/{id}/info` | Get phone info (name, screen size) |
| `GET /phones/{id}/status` | Get phone status (connection, Switch Control, streaming) |
| `GET /phones/{id}/settings` | Get phone settings |
| `PATCH /phones/{id}/settings` | Update phone settings |
| `GET /phones/{id}/apps` | List installed apps |
| `POST /phones/{id}/copy-text` | Copy text to phone clipboard |
