...
The TapKit plugin for Codex gives the agent iPhone control in your terminal. It installs an MCP server connection and TapKit skills that teach Codex how to use the tools and navigate supported apps.
