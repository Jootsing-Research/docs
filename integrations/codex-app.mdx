...
The TapKit plugin for Codex gives the agent iPhone control in the desktop app. It installs an MCP server connection and TapKit skills that teach Codex how to use the tools and navigate supported apps.
...
- **Skills** — teach Codex how to use the coordinate system, screenshot loop, gesture types, and supported apps
